...
public abstract class BaseChatbotResourceImpl implements ChatbotResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/chatbot/v1.0/chat' -d $'{"messages": ___, "openAPIURL": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Send a text message to Chatbot and receive a response."
	)
